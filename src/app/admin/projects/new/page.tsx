  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">{t.projects.addNew}</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-5">
          ...
          {imageUrl ? (
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-green-500 transition-colors">
              <input type="file" accept="image/*" onChange={handleFileUpload} disabled={isUploading} className="hidden" id="file-upload-new" />
              ...
              <>
                <div>
                  ...
                  <input type="text" value={formData.type_ru} onChange={(e) => setFormData({ ...formData, type_ru: e.target.value })}
                    className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="Студия" />
                ...
                <div>
                  ...
                  <input type="text" value={formData.area_ru} onChange={(e) => setFormData({ ...formData, area_ru: e.target.value })}
                    className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="от 28 м²" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">{t.projects.descriptionRu}</label>
                  <RichTextEditor value={formData.description_ru} onChange={(value) => setFormData({ ...formData, description_ru: value })} placeholder="Уютная студия с панорамными видами" />
                </div>
              </>
            ) : langTab === "uz" ? (
              <>
                <div>
                  ...
                  <input type="text" value={formData.type_uz} onChange={(e) => setFormData({ ...formData, type_uz: e.target.value })}
                    className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="Studiya" />
                </div>
                <div>
                  ...
                  <input type="text" value={formData.area_uz} onChange={(e) => setFormData({ ...formData, area_uz: e.target.value })}
                    className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="28 m² dan" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">{t.projects.descriptionUz}</label>
                  <RichTextEditor value={formData.description_uz} onChange={(value) => setFormData({ ...formData, description_uz: value })} placeholder="Panoramali ko'rinishga ega qulay studiya" />
                </div>
              </>
            ) : (
              <>
                <div>
                  ...
                  <input type="text" value={formData.type_en} onChange={(e) => setFormData({ ...formData, type_en: e.target.value })}
                    className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder={t.projects.roomTypePlaceholderEn} />
                </div>
                <div>
                  ...
                  <input type="text" value={formData.area_en} onChange={(e) => setFormData({ ...formData, area_en: e.target.value })}
                    className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder={t.projects.areaPlaceholderEn} />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">{t.projects.descriptionEn}</label>
                  <RichTextEditor value={formData.description_en} onChange={(value) => setFormData({ ...formData, description_en: value })} placeholder={t.projects.descPlaceholderEn} />
                </div>
              </>
            )}
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-5">
          <div className="flex items-center gap-2">
            <input type="checkbox" id="is_published_new" checked={formData.is_published}
              onChange={(e) => setFormData({ ...formData, is_published: e.target.checked })}
              className="w-4 h-4 rounded text-green-600 focus:ring-green-500" />
            <label htmlFor="is_published_new" className="text-sm text-gray-700">{t.projects.publishLabel}</label>
          </div>
        </div>
