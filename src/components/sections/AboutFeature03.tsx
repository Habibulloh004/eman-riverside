...
export default function AboutFeature03() {
  ...
  const number = "03";
  const label = t.feature03.label;
  const title = t.feature03.title;
  const titleLine2 = t.feature03.titleLine2;
  const image = "/images/hero/1.png";
  const description = t.feature03.description;
  const features = t.feature03.features;

  return (
    <section id="feature-03" className="relative py-24 lg:py-32 scroll-mt-20 bg-[#F9EFE7] overflow-hidden" data-page-section-anim="true">
